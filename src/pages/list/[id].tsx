...
const ListView = ({ list }: ListViewProps) => {
    ...
    return (
        <>
            <h3 className="text-5xl text-zinc-100 py-10">{list.name}</h3>
...
const SingleListPage: NextPage<PageProps> = ({ id }) => {
    ...
    return (
        <>
            ...
            <main className="flex min-h-screen flex-col items-center justify-center bg-steel-900 text-zinc-100">
